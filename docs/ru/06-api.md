...
- buyer cannot purchase own product
...
- success path creates purchase access once

### `POST /library/{product_id}/files/{file_id}/download`

- active purchase access required
- product file must be current and clean
